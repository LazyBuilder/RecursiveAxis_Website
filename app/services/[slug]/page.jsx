...
const ServiceDetailPage = async ({ params }) => {
  ...
  const dataIndex = slugMap[slug];
  const service = dataIndex !== undefined ? SERVICE_DATA[dataIndex] : null;
  ...
  return (
    <div className={`min-h-screen ${LIGHT_BACKGROUND} ${LIGHT_TEXT} py-20 md:py-32`}>
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <Link
          href="/services"
          className="inline-flex items-center text-gray-500 hover:text-pink-600 transition-colors font-medium mb-12 group"
        >
