...
const projectData = [
    ...
    { 
        ...
        description: "Built a secure, real-time analytics dashboard for wealth management clients using Node.js, PostgreSQL, and React. Focused on data visualization and robust authentication.", 
        tags: ['Node.js', 'Website', 'FinTech'], 
        imageSrc: VerveImage, 
        link: '#', 
    ...
    { id: 3, 
        ...
        description: "Automated E2E CI/CD pipeline using Jenkins and Kubernetes for zero-downtime deployment.", 
        tags: ['Kubernetes', 'Strategy', 'DevOps'], 
        imageSrc: null, 
        link: '#', 
        color: colors.secondary,
     },
    ...
    { id: 4, 
        ...
        description: "Delivered a full-featured, multi-language ticketing and information platform emphasizing ultra-low-cost deployment using React and AWS Amplify. The platform handles thousands of ticket transactions annually and significantly reduced manual overhead.", 
        tags: ['React', 'Website', 'Non-profit'], 
        imageSrc: MSHImage, 
    ...
    { id: 5, 
        ...
        description: "A high-impact portfolio site optimized for speed and retina displays using React and Tailwind CSS.", 
        tags: ['Tailwind', 'Website', 'Design'], 
        imageSrc: null, 
    ...
    { id: 6, 
        ...
        description: "Designed and implemented a scalable microservices architecture for a mid-sized e-commerce platform handling 10k+ daily transactions. Utilized RabbitMQ for message queuing, Docker for containerization, and implemented circuit breakers for resilience, ensuring high availability and fault tolerance across all core services including inventory, payments, and fulfillment. This was a critical production system upgrade.", 
        tags: ['Microservices', 'Code', 'E-commerce'], 
    ...
    { id: 7, 
        ...
        description: "Mobile-first web app using Firebase and React Native Web for real-time tracking of community recycling efforts, resulting in a 20% increase in volume.", 
        tags: ['React Native', 'Website', 'Community'], 
        imageSrc: MSHImage, link: '#', 
        color: colors.primary, 
    },
    // Short Text, No Image (Should be SHORT/SHRUNK)
    { id: 8, 
        title: "Healthcare Portal Compliance", 
        description: "Designed and implemented a HIPAA-compliant patient communication portal on AWS, focusing on security and data privacy.", 
        tags: ['AWS', 'Reports', 'Healthcare'], 
        imageSrc: null, link: '#', 
        color: colors.secondary, 
    },
    { id: 9, 
        title: "Real-Time NLP Chatbot", 
        description: "Developed a natural language processing model using Hugging Face transformers for a customer service chatbot.", 
        tags: ['Python', 'Code', 'NLP'], 
        imageSrc: MSHImage, link: '#', 
        color: colors.primary, 
    },
    { id: 10, 
        title: "High-Speed Caching Service", 
        description: "Implemented a Redis-based caching layer that reduced database load times by 75% for key endpoints.", 
        tags: ['Redis', 'Code', 'Performance'], 
        imageSrc: null, link: '#', 
        color: colors.secondary, 
    },
];
