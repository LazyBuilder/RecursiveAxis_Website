...
const TRUSTED_COMPANIES = [
  ...
  { name: 'Innovation Factory', url: 'https://innovationfactory.ca/', logo: `${process.env.PUBLIC_URL}/assets/asit_logos/public/assets/asit_logos/iF_Logo.png` },
  { name: 'FutureSight', url: 'https://futuresight.ventures/' , logo: `${process.env.PUBLIC_URL}/assets/asit_logos/public/assets/asit_logos/FutuSight_Logo.png` },
